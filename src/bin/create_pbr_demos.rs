...
fn create_camera_spec() -> ComponentSpec {
    ComponentSpec {
        ...
        output_spec: vec![
            PortSpec { name: "view_matrix".to_string(), data_type: DataType::Mat4, optional: false, description: "View matrix".to_string() },
            PortSpec { name: "projection_matrix".to_string(), data_type: DataType::Mat4, optional: false, description: "Projection matrix".to_string() },
            PortSpec { name: "camera_position".to_string(), data_type: DataType::Vec3, optional: false, description: "Camera world position".to_string() },
            PortSpec { name: "view_direction".to_string(), data_type: DataType::Vec3, optional: false, description: "View direction".to_string() },
        ],
        required_capabilities: vec![],
...
fn create_pbr_material_spec() -> ComponentSpec {
    ComponentSpec {
        ...
        input_spec: vec![
            PortSpec { name: "base_color".to_string(), data_type: DataType::Vec3, optional: false, description: "Base color (albedo)".to_string() },
        ...
        output_spec: vec![
            PortSpec { name: "f0".to_string(), data_type: DataType::Vec3, optional: false, description: "Fresnel F0".to_string() },
            ...
            PortSpec { name: "base_color".to_string(), data_type: DataType::Vec3, optional: false, description: "Base color".to_string() },
        ],
        required_capabilities: vec![],
