...
impl MetadataGuest for Component {
    fn get_info() -> ComponentInfo {
        ComponentInfo {
            name: "Vec3 Add".to_string(),
            version: "1.0.0".to_string(),
            description: "Add two 3D vectors component-wise".to_string(),
...
mod tests {
    ...
    #[test]
    fn test_vec3_add_basic() {
        let inputs = vec![
            ("a".to_string(), Value::Vec3Val(Vec3 { x: 1.0, y: 2.0, z: 3.0 })),
            ("b".to_string(), Value::Vec3Val(Vec3 { x: 4.0, y: 5.0, z: 6.0 })),
        ];
    ...
    #[test]
    fn test_vec3_add_negative() {
        let inputs = vec![
            ("a".to_string(), Value::Vec3Val(Vec3 { x: 10.0, y: 20.0, z: 30.0 })),
            ("b".to_string(), Value::Vec3Val(Vec3 { x: -5.0, y: -10.0, z: -15.0 })),
        ];
